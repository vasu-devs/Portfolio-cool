                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-[2vw] md:gap-2">
                                {category.skills.map((skill, sIdx) => (
                                    <span
                                        key={sIdx}
                                        className="px-[3vw] py-[1vw] md:px-4 md:py-1.5 rounded-full bg-fg-primary/5 border border-fg-primary/10 text-[3vw] md:text-sm font-mono text-fg-secondary group-hover:text-fg-primary group-hover:border-fg-primary/30 transition-colors"
                                    >
                                        {skill}
                                    </span>
                                ))}
