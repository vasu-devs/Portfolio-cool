    ...
    return (
        <MagneticButton>
            <a
                ...
                aria-label={label}
                className="group relative flex items-center justify-center p-3 md:w-14 md:h-14 rounded-full border border-fg-primary/10 bg-fg-primary/[0.03] backdrop-blur-md overflow-hidden transition-all duration-500 hover:border-fg-primary/30"
            >
