        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-[3vw] md:p-[2vw]">
                    ...
                    >
                        {/* Sticky header */}
                        <div className="flex justify-between items-start gap-4 px-[6vw] md:px-8 py-[4vw] md:py-5 border-b border-border-primary bg-bg-primary/80 backdrop-blur-md z-20">
                        ...
                        >
                            ...
                            {/* Case study content */}
                            <div className="px-[6vw] md:px-8 py-[6vw] md:py-10">
                                {/* Lead paragraph */}
                                <p className="text-[4vw] md:text-xl text-fg-primary leading-relaxed mb-[6vw] md:mb-8 font-medium max-w-3xl">
