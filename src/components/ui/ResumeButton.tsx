    ...
    return (
        <MagneticButton onClick={handleClick}>
            <motion.a
                ...
                whileHover="hover"
                animate="initial"
                className={`group relative flex items-center gap-2 px-3 py-3 md:gap-3 md:px-8 md:py-4 rounded-full border border-fg-primary/30 bg-gradient-to-br from-fg-primary/[0.18] via-fg-primary/[0.10] to-fg-primary/[0.04] backdrop-blur-2xl backdrop-saturate-150 shadow-[0_10px_30px_rgba(0,0,0,0.18),inset_0_1px_1px_rgba(255,255,255,0.25),inset_0_-1px_1px_rgba(0,0,0,0.12)] overflow-hidden transition-all duration-500 hover:border-fg-primary/50 hover:shadow-[0_14px_40px_rgba(0,0,0,0.28),inset_0_1px_1px_rgba(255,255,255,0.3),inset_0_-1px_1px_rgba(0,0,0,0.15)] font-mono text-xs uppercase tracking-widest ${className}`}
            >
