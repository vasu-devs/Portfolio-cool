    ...
    return (
        <MagneticButton onClick={handleClick}>
            <motion.a
                ...
                whileHover="hover"
                animate="initial"
                className={`group relative flex items-center gap-2 px-3 py-3 md:gap-3 md:px-8 md:py-4 rounded-full border border-fg-primary/10 bg-fg-primary/[0.03] backdrop-blur-md overflow-hidden transition-all duration-500 hover:border-fg-primary/30 font-mono text-xs uppercase tracking-widest ${className}`}
            >
