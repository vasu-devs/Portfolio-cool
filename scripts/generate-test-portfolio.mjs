...
const template = readFileSync(resolve(root, 'scripts/minimal-portfolio.template.html'), 'utf8');
...
console.log('Generated compact /test portfolio from approved public content.');
