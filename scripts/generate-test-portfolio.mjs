...
${contactBlock('page')}
<div class="contact-details"><dl class="contact-facts"><div><dt>Based in</dt><dd>India · IST (UTC+5:30)</dd></div><div><dt>Looking for</dt><dd>AI engineering and full-stack roles, freelance builds</dd></div><div><dt>Currently</dt><dd>AI Engineering intern at withlayer.ai</dd></div></dl></div>
</section>`;
  })(),
