...
const template = readFileSync(resolve(root, 'scripts/playground-portfolio.template.html'), 'utf8');
...
console.log('Generated playful 3D /test portfolio from approved public content.');
