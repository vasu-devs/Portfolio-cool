...
const coverFor=(name,realm)=>updatedCovers.has(name)?`/test/covers/${name.toLowerCase()}-architecture-${realm}-v10.svg`:`/test/covers/${name.toLowerCase()}-${realm}-v2.webp`;
