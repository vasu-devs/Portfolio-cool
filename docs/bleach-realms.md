...
Seireitei remains color-only. Hueco Mundo now uses an original generated anime-inspired white desert and crescent-night background, requested after the color-only version. Static CSS shading protects the reading area; the background has no input handlers or animation loops. Prompt and provenance: hueco-background-prompt.txt.
